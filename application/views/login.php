...
<body>
    ...
    <div id="container">
        ...
        <div>
            <p class="center-text">¿No tienes una cuenta? <a href="<?php echo base_url('auth/registro'); ?>">Registrarse</a></p>
        </div>
        <?php echo form_close(); ?>
        <div>
            <p class="center-text">¿Olvidaste tu contraseña? <a href="<?php echo base_url('recuperacion'); ?>">Recuperar</a></p>
        </div>
    </div>
    <footer >
        <div class="container">
