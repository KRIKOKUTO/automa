...
/*
$config['sess_driver'] = 'database'; // Utilizar driver de base de datos
...
$config['sess_save_path'] = 'ci_sessions'; // Nombre de la tabla si estás usando 'database' como driver
$config['sess_match_ip'] = FALSE; // Si TRUE, verificará la IP del cliente durante la sesión
$config['sess_time_to_update'] = 300; // Tiempo para actualizar la sesión en segundos
$config['sess_regenerate_destroy'] = FALSE;
*/
/*
|--------------------------------------------------------------------------
...
|--------------------------------------------------------------------------
|
| These are the allowed file types for uploading:
|
| 'allowed_types'    => 'jpg|jpeg|png|gif|pdf|zip',
|
| And here's a method to limit the name used for the uploaded file. The
| default setting accepts the original file name provided by the client,
| but you can change it to use a different name if necessary:
|
| 'file_name'        => 'my_file',
|

$config['upload_path'] = array(
    FCPATH . 'Generados/',
    FCPATH . 'Obtenidos/',
    FCPATH . 'Catalogos/'
);
$config['allowed_types'] = 'gif|jpg|png|pdf|zip'; // Tipos de archivos permitidos, incluyendo ZIP
*/
